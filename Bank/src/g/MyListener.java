		...
		try {
...

			{
				...
				PreparedStatement ps = con.prepareStatement(
						"CREATE TABLE  NEWACCOUNT(ACCOUNTNO bigint,USERNAME VARCHAR(4000),PASSWORD VARCHAR(4000),REPASSWORD VARCHAR(4000),AMOUNT bigint,ADDERESS VARCHAR(4000),PHONE bigint,PRIMARY KEY (ACCOUNTNO))");
				ps.executeUpdate();
